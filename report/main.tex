...
\geometry{left=2.54cm,right=2.54cm,top=3.85cm,bottom=2.54cm}
...
\AddToShipoutPictureFG{%
    \AtPageUpperLeft{%
        \raisebox{-3.35cm}[0pt][0pt]{%
            \hspace*{2.54cm}\includegraphics[width=4.5cm]{figures/logo_utec_cropped.png}%
        }%
    }%
}
