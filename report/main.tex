...
\geometry{margin=2.54cm,includehead}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\includegraphics[width=4.5cm]{figures/logo_utec_cropped.png}}
\fancyhead[R]{\thepage}
...
\begin{titlepage}
    ...
    \noindent\includegraphics[width=4.5cm]{figures/logo_utec_cropped.png}
    \vspace{-0.1cm}
